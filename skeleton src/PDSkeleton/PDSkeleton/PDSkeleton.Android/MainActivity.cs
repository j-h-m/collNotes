...
{
    [Activity(Label = "PDSkeleton", Icon = "@mipmap/pd_launcher_icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
